package esercizio6.server;

import esercizio6.UsernameUsedException;
...
public class RequestThread extends Thread {
    ...
    private void comunicateWithClient() throws IOException {
        ...
        while (!exit) {
            out.println("Enter a new command (" + username + "): ");
            input = in.readLine();
    ...
    public void run() {
        try {
            ...
            out.println("Welcome, you are now connected to the server!");
